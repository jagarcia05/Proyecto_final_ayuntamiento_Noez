...
<header class="shadow-sm z-1">
  <!-- Cinta superior con teléfono y email -->
  ...
  <div class="bg- py-3 border-bottom">
    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between text-center text-md-start gap-3">
      <div class="d-flex align-items-center justify-content-center justify-content-md-start flex-wrap text-center text-md-start">
        <img src="/Proyecto_final_ayuntamiento_Noez/img/imagen_escudo.png" alt="Escudo de Noez" class="img-fluid me-3 mb-2 mb-md-0" style="height: 100px;" />
      ...
      <div class="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2">
        <button type="button" class="btn-ayuntamiento btn" data-bs-toggle="modal" data-bs-target="#ModalIniciarSesion" id="iniciar-session1">Iniciar Sesión</button>
        <h3 class="mb-0 fs-4 d-none text-center" id="usuario-nombre"></h3>
        <button type="button" class="btn-ayuntamiento btn d-none" id="cerrar-sesion">Cerrar Sesion</button>
      </div>
    </div>
    ...
    <div class="modal fade" id="ModalIniciarSesion" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-primary">
          ...
          <form action="/Proyecto_final_ayuntamiento_Noez/Controller?operacion=login" method="post">
    ...
    <!-- Navbar principal -->
    <nav class="navbar navbar-expand-lg bg-principal navbar-dark justify-content-center mt-3 mt-md-0">
      <div class="container justify-content-center">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="mainNav">
          <ul class="navbar-nav flex-wrap justify-content-center text-center text-md-start">
            <li class="nav-item">
              <a class="nav-link" href="/Proyecto_final_ayuntamiento_Noez/Controller?operacion=inicio">Inicio</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="puebloDropdown" role="button" data-bs-toggle="dropdown">Pueblo</a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="areasDropdown" role="button" data-bs-toggle="dropdown">Áreas</a>
              <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="ayuntamientoDropdown" role="button" data-bs-toggle="dropdown">Ayuntamiento</a>
              <ul class="dropdown-menu">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="infoDropdown" role="button" data-bs-toggle="dropdown">Información</a>
              <ul class="dropdown-menu">
...
function inicializarLogin() {
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", function (event) {
            ...
            fetch("/Proyecto_final_ayuntamiento_Noez/Controller?operacion=login1", {
                method: "POST",
                headers: {

    ...
    <div class="bg- py-3 border-bottom">
        <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <div class="d-none d-md-block">
                <button type="button" class="btn-ayuntamiento btn mt-3" data-bs-toggle="modal" data-bs-target="#ModalIniciarSesion">
                    Iniciar Sesión
                </button>
            </div>
        </div>
                ...
                <div class="collapse navbar-collapse justify-content-center" id="mainNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">Pueblo</a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">Áreas</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/Areas/JuventudDeporte.html">Juventud y <br> Deporte</a></li>
                                <li><a class="dropdown-item" href="/Areas/CulturaEducacionFestejo.html">Cultura, <br> Educación, <br> Festejos</a></li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">Ayuntamiento</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">Información</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/Controller?Operacion=listaNoticias">Noticias</a></li>
                                <li><a class="dropdown-item" href="/Controller?Operacion=listarEventos">Eventos</a></li>
                            </ul>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="https://noez.sedelectronica.es/info.0">
                                <i class="fa fa-reply pe-2"></i>Sede Electrónica
                            </a>
                        </li>
...
// Inserta el header y muestra menú admin si corresponde
